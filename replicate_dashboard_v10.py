"""
Dashboard 정밀 복제 v10 (Solid Red Fill & Axis Fix)
1. 지출 막대 (음수) 색상 채우기 이슈 해결: invertIfNegative = False 설정
2. Y축 눈금 레이블(숫자) 표시 보장
"""
import openpyxl
...
if '📊 Dashboard_v10' in wb.sheetnames: del wb['📊 Dashboard_v10']
ws_new = wb.create_sheet('📊 Dashboard_v10')
...
# [축 개선]
c1.y_axis.delete = False # 삭제 방지
c1.y_axis.tickLblPos = "nextTo" # 레이블 표시
c1.y_axis.majorTickMark = "out" # 눈금 밖으로
# 숫자 서식 추가 (콤마 표시 등)
# c1.y_axis.numFmt = "#,##0"
...
# 당부의 말: 저장 경로 확인
output_path = r'c:\Users\JTC7\Desktop\01.Python Project\01.Personal Expense Tracker\01.Document\20251214_Dashboard_v10_final.xlsx'
wb.save(output_path)
