"""
Dashboard 정밀 복제 v12 (Axes & Legend Fix)
1. 축 제목 복구: X축="월", Y축="금액"
2. 범례 이름/색상 확정: 수입(파랑), 지출(빨강), 합계(녹색)
"""
import openpyxl
...
# [축 설정]
c1.x_axis.title = "월"   # 요청사항 1
c1.y_axis.title = "금액" # 요청사항 1
c1.y_axis.tickLblPos = "nextTo"
c1.y_axis.majorTickMark = "out"

# [데이터]
# 헤더 포함 (11행) -> titles_from_data=True로 하면 엑셀이 알아서 읽지만, 
# 사용자가 명확한 텍스트를 원하므로 직접 title을 덮어씌웁니다.
...
# [범례 이름 & 색상 강제 지정]
# Series 0: 수입
c1.series[0].title = "수입" # 요청사항 2
c1.series[0].graphicalProperties.solidFill = "4472C4" # 파랑
c1.series[0].graphicalProperties.line.solidFill = "4472C4"

# Series 1: 지출
c1.series[1].title = "지출" # 요청사항 2
...
c3.series[0].title = "카테고리별 지출"
c3.series[1].title = "월평균 지출"
...
output_path = r'c:\Users\JTC7\Desktop\01.Python Project\01.Personal Expense Tracker\01.Document\20251214_Dashboard_v12_final_final.xlsx'
wb.save(output_path)
